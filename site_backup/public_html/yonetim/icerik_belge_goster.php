...
if (isset($_POST['onayla']) && isset($_POST['toplusilme']) && $_POST['onayla']==1 && $_POST['toplusilme']==1) {  
...
if (isset($_POST['onayla']) && isset($_POST['emailgonder']) && $_POST['onayla']==1 && $_POST['emailgonder']==1) {  
...
$bilgiald = isset($_GET['bilgigonder']) ? temizlikimandan($_GET['bilgigonder']) : ''; 
$belgeald = isset($_GET['belgegonder']) ? temizlikimandan($_GET['belgegonder']) : '';
$toplusonuc = '';

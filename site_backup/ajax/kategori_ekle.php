...
<link href="../public_html/yonetim/css/bootstrap.min.css" rel="stylesheet">
<link href="../public_html/yonetim/css/bootstrap-overrides.css" rel="stylesheet">
<link href="../public_html/yonetim/css/jquery-ui-1.10.2.custom.css" rel="stylesheet">
<link href="../public_html/yonetim/css/font-awesome.css" rel="stylesheet">
<link href="../public_html/yonetim/css/style.default.css" rel="stylesheet">
<script type="text/javascript" src="../public_html/yonetim/js/jquery-1.11.1.min.js"></script>
<script type="text/javascript" src="../public_html/yonetim/js/jquery-migrate-1.2.1.min.js"></script>
<script type="text/javascript" src="../public_html/yonetim/js/bootstrap.min.js"></script>
<script type="text/javascript" src="../public_html/yonetim/js/jquery-ui-1.10.3.min.js"></script>
<script type="text/javascript" src="../public_html/yonetim/js/jquery.gritter.min.js"></script>
</head>
<body>
...
<input class="form-control tooltips" name="trisim"  id="trisim"  required placeholder="Lütfen Türkçe Kategori Adı Giriniz" style="margin-top: 30px" value="<?php echo isset($kayitsonucl['tr_isim']) ? htmlspecialchars($kayitsonucl['tr_isim']) : ''; ?>" />     
</div>
<div class="form-group">
...
<script src="../public_html/yonetim/js/jquery-migrate-1.2.1.min.js"></script>
<script src="../public_html/yonetim/js/bootstrap.min.js"></script>
<script src="../public_html/yonetim/js/jquery-ui-1.10.3.min.js"></script>
<script src="../public_html/yonetim/js/jquery.gritter.min.js"></script>
<script src="../public_html/yonetim/js/custom.js"></script>
<script>
    function kapat() {
        window.close();
    }

...
<script type="text/javascript">/* <![CDATA[ */
	if (window.ColdFusion) ColdFusion.required['process_date']=true;
...
<script>
            jQuery(document).ready(function() {
                ...
                jQuery('#timepicker3').timepicker({minuteStep: 15});
				  jQuery('#timepicker23').timepicker({showMeridian: false});
                	  jQuery('#timepicker24').timepicker({showMeridian: false});
                // Date Picker
                ...
                jQuery('#select-search-hide').select2({
                 ...
                 jQuery('#select-search-hide2').select2({
                    minimumResultsForSearch: -1
                });
                
                 jQuery('#select-search-hide3').select2({
                    minimumResultsForSearch: -1
                });
                
                 jQuery('#select-search-hide4').select2({
                    minimumResultsForSearch: -1
                });
                
                 jQuery('#select-search-hide5').select2({
                    minimumResultsForSearch: -1
                });

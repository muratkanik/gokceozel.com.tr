							...
							$.ajax({
								...
								success: function(response) {
									if (response.success) {
										...
										// Captcha görselini yenile
										$('#captcha_image').attr('src', 'form/captcha_image.php?rand=' + Math.random());
									} else {
										$('.errorform p', $contactform).text(response.message || 'Bir hata oluştu!');
								...
								error: function(xhr, status, error) {
									...
									$('.errorform p', $contactform).text(errorMsg);
									$('.errorform', $contactform).fadeIn();
									// Captcha görselini yenile
									$('#captcha_image').attr('src', 'form/captcha_image.php?rand=' + Math.random());
								}

...
export default function ClientPage({ params, settings }: PageProps & { settings: Record<string, string> }) {
        ...
        <div className="grid md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="soft-card rounded-[1.35rem] p-6 space-y-5">
              <div className="flex-col sm:flex-row flex items-start gap-3 justify-between">
                <ContactItem icon="📍" label={t.address} value={settings.contact_address || t.addressVal} />
                <a 
                  href={`https://www.google.com/maps/dir/?api=1&destination=${settings.contact_lat || 39.9118045},${settings.contact_lng || 32.7686267}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-2 sm:mt-0 flex-shrink-0 bg-[#d4b97a]/10 text-[#6f5526] hover:bg-[#d4b97a]/20 border border-[#d4b97a]/30 px-4 py-2 rounded-lg text-sm font-semibold transition-colors flex items-center gap-2"
                >

...
export const POPUP_THEMES: Record<string, PopupTheme> = {
  ...
  'theme-anneler-gunu':   { headerBg: '#e91e8c', accentColor: '#ad1457', btnBg: '#e91e8c', btnText: '#fff', btnHover: '#ad1457', shadowColor: 'rgba(233,30,140,0.35)', style: 'hero', defaultImage: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?q=80&w=1200&auto=format&fit=crop' },
